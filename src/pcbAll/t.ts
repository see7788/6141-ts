...
export interface Store_t {
    ...
    pcbDz002s: {
        ...
        dbOn: (...op:
            ...
            | [dz002s_id_t, "dz002s_wsclose_set"]
        ...
        ws: {
            ...
            onMessage: (
                ...op:
                    | Extract<Parameters<Store_t["pcbDz002s"]["dbOn"]>, [dz002s_id_t, "dz002s_yblState_publish", ...any[]]>
    ...
    admins: {
        ws: {
            sendToAll: (...op:
                | ReturnType<Store_t["pcbDz002s"]["dbOn"]>
            ...
            onMessage: (
                ...op:
                    | Extract<Parameters<Store_t["pcbDz002s"]["dbOn"]>, [dz002s_id_t, "dz002s_yblConfig_set" | "dz002s_mcuConfig_set" | "dz002s_set", ...any[]]>
    ...
    visitor: {
        ws: {
            sendToAll: (...op: ReturnType<Store_t["pcbDz002s"]["dbOn"]>) => void;
