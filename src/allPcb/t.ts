...
import { mcu_ybl_idInfo_t as yblId_base_t, mcu_ybldatas_t } from "../dz002/cppWeb/protected/mcu_ybl/.t"
import { macId_t, on_t as dz002_on_t, returnBase_t } from "../dz002/cppUse/t"
...
export interface Store_t {
    dz002: {
            ...
            fun: {
                dz002: {
                    ws: {
                        ...
                        on: (
                            ...op: Extract<ReturnType<dz002_on_t>, [...returnBase_t, "mcu_ybldatas_publish", ...any[]]>
        ...
        wsClis: Map<macId_t, WsClient>;
        wsServer: WsClient.Server;
        wsFun: {
    ...
    admin: {
        ...
        wsServer: WsClient.Server;
        wsClis: Map<string, WsClient>;
        wsFun: {
            on: (
                ...op: Parameters<
                    Store_t["dz002"]["wsFun"]["send"] |
